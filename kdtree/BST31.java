 ...
 * @author Kevin Wayne
 */
public class BST31<Key extends Comparable<Key>, Value> {
    ...
    private class BST3Iterator implements Iterator<Key> {
        private final BST31<Key, Value> bst3;
        private Node node;

        public BST3Iterator(BST31<Key, Value> bst3) {
            this.bst3 = bst3;
            node = root;
        }
    ...
    public static void main(String[] args) {
        BST31<String, Integer> st = new BST31<String, Integer>();
